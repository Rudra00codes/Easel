...
import { FC, JSX, useEffect, useRef, useState, useCallback, memo } from "react";
...
const DefaultCursorSVG: FC = memo(() => {
  return (
    <svg
...
export const SmoothCursor = memo(({
  ...
  const smoothMouseMove = useCallback((e: MouseEvent) => {
